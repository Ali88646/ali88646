...
Frontend Developer specializing in building scalable web and mobile applications using modern JavaScript frameworks.


## 👩‍💻 About Me

- 💻 Frontend Developer (React, Next.js, React Native)
- ⚡ Focused on real-time systems, clean UI, and performance
- 📱 Experienced in building production-level mobile and web apps
- 🧠 Strong interest in scalable architecture and system design
- 🎯 Goal: Build high-quality, user-centric applications
...
- 💼 https://www.linkedin.com/in/ali88646/
